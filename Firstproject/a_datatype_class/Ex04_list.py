...
a = ['인천','부산',['전라','경상'],['대전','광주','대구'], '서울','제주']
print('--------연습2---------')
print(a[:4]) #or print(a[1:5])
print(a[3:])
print(a[:-1]) #or print(a[:5])
print(a[-3][1:])
...
"""
    ...
    (3) 0번째 요소로 1을 추가 #a.insert(0,1)
    (4) 3번째 요소로 1을 추가 #a.insert(3,1)
    (5) 리스트 맨 마지막 요소를 꺼낸다 #a.pop()
    (6) 요소 1을 삭제 ( 1이 여러개인 경우 맨 앞에 하나만 삭제됨 ) #a.remove(1)
    (7) 리스트 모든 요소를 삭제 #a.clear()
"""
a = [7, 2, 3, 5, 6]
a.append(0)
print(a)
...
del a[:2] #remove(a[0]) 명령을 두 번 해야 함
print(a)
#[4, 5, 8, 1, 2]
...
print(b is a)
b[0]=100
print(a,b) # [100, 5, 2, 6] [100, 5, 2, 6]

print()
a=[4, 5, 2, 6]
b=a[:]  # 깊은 복사 (값을 복사 , 새로 주소를 파서 값을 복사)
print(b)
print(b is a)
b[0]=100
print(a,b) #[4, 5, 2, 6] [100, 5, 2, 6]
